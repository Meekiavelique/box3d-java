...
public class b3ContactEvents {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        box3d_rollback_h.C_POINTER.withName("beginEvents"),
        box3d_rollback_h.C_POINTER.withName("endEvents"),
        box3d_rollback_h.C_POINTER.withName("hitEvents"),
        box3d_rollback_h.C_INT.withName("beginCount"),
        box3d_rollback_h.C_INT.withName("endCount"),
        box3d_rollback_h.C_INT.withName("hitCount"),
