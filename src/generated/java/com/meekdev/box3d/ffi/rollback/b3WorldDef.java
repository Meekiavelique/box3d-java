...
public class b3WorldDef {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        box3d_rollback_h.C_FLOAT.withName("restitutionThreshold"),
        box3d_rollback_h.C_FLOAT.withName("hitEventThreshold"),
        box3d_rollback_h.C_FLOAT.withName("contactHertz"),
        box3d_rollback_h.C_FLOAT.withName("contactDampingRatio"),
        box3d_rollback_h.C_FLOAT.withName("contactSpeed"),
        box3d_rollback_h.C_FLOAT.withName("maximumLinearSpeed"),
        MemoryLayout.paddingLayout(4),
        box3d_rollback_h.C_POINTER.withName("frictionCallback"),
        box3d_rollback_h.C_POINTER.withName("restitutionCallback"),
        box3d_rollback_h.C_BOOL.withName("enableSleep"),
        box3d_rollback_h.C_BOOL.withName("enableContinuous"),
        MemoryLayout.paddingLayout(2),
        box3d_rollback_h.C_INT.withName("workerCount"),
        box3d_rollback_h.C_POINTER.withName("enqueueTask"),
        box3d_rollback_h.C_POINTER.withName("finishTask"),
        box3d_rollback_h.C_POINTER.withName("userTaskContext"),
        box3d_rollback_h.C_POINTER.withName("userData"),
        box3d_rollback_h.C_POINTER.withName("createDebugShape"),
        box3d_rollback_h.C_POINTER.withName("destroyDebugShape"),
        box3d_rollback_h.C_POINTER.withName("userDebugShapeContext"),
        b3Capacity.layout().withName("capacity"),
        box3d_rollback_h.C_INT.withName("internalValue")
    ).withName("b3WorldDef");
