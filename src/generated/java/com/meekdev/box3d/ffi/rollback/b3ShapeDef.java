...
public class b3ShapeDef {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        box3d_rollback_h.C_POINTER.withName("name"),
        box3d_rollback_h.C_POINTER.withName("userData"),
        box3d_rollback_h.C_POINTER.withName("materials"),
        box3d_rollback_h.C_INT.withName("materialCount"),
        MemoryLayout.paddingLayout(4),
        b3SurfaceMaterial.layout().withName("baseMaterial"),
        box3d_rollback_h.C_FLOAT.withName("density"),
        box3d_rollback_h.C_FLOAT.withName("explosionScale"),
        b3Filter.layout().withName("filter"),
        box3d_rollback_h.C_BOOL.withName("enableCustomFiltering"),
        box3d_rollback_h.C_BOOL.withName("isSensor"),
        box3d_rollback_h.C_BOOL.withName("enableSensorEvents"),
        box3d_rollback_h.C_BOOL.withName("enableContactEvents"),
        box3d_rollback_h.C_BOOL.withName("enableHitEvents"),
        box3d_rollback_h.C_BOOL.withName("enablePreSolveEvents"),
        box3d_rollback_h.C_BOOL.withName("invokeContactCreation"),
        box3d_rollback_h.C_BOOL.withName("updateBodyMass"),
        box3d_rollback_h.C_BOOL.withName("enableSpeculativeContact"),
