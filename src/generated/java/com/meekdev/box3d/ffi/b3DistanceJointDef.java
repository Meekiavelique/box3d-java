...
public class b3DistanceJointDef {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        box3d_h.C_FLOAT.withName("length"),
        box3d_h.C_BOOL.withName("enableSpring"),
        MemoryLayout.paddingLayout(3),
        box3d_h.C_FLOAT.withName("lowerSpringForce"),
        box3d_h.C_FLOAT.withName("upperSpringForce"),
        box3d_h.C_FLOAT.withName("hertz"),
        box3d_h.C_FLOAT.withName("dampingRatio"),
        box3d_h.C_BOOL.withName("enableLimit"),
        MemoryLayout.paddingLayout(3),
        box3d_h.C_FLOAT.withName("minLength"),
        box3d_h.C_FLOAT.withName("maxLength"),
        box3d_h.C_BOOL.withName("enableMotor"),
        MemoryLayout.paddingLayout(3),
        box3d_h.C_FLOAT.withName("maxMotorForce"),
        box3d_h.C_FLOAT.withName("motorSpeed")
