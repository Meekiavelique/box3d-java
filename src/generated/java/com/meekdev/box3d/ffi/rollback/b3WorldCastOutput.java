 ...
 * }
 */
public class b3WorldCastOutput {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        box3d_rollback_h.C_FLOAT.withName("fraction"),
        box3d_rollback_h.C_INT.withName("iterations"),
        box3d_rollback_h.C_INT.withName("triangleIndex"),
        box3d_rollback_h.C_INT.withName("childIndex"),
        box3d_rollback_h.C_INT.withName("materialIndex"),
        box3d_rollback_h.C_BOOL.withName("hit"),
        MemoryLayout.paddingLayout(3)
    ).withName("b3WorldCastOutput");
