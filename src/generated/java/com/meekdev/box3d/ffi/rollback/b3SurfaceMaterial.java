...
public class b3SurfaceMaterial {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        box3d_rollback_h.C_FLOAT.withName("friction"),
        box3d_rollback_h.C_FLOAT.withName("restitution"),
        box3d_rollback_h.C_FLOAT.withName("rollingResistance"),
        b3Vec3.layout().withName("tangentVelocity"),
        box3d_rollback_h.C_LONG.withName("userMaterialId"),
        box3d_rollback_h.C_INT.withName("customColor"),
