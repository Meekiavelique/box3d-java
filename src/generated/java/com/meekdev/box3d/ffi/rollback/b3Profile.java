...
public class b3Profile {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        box3d_rollback_h.C_FLOAT.withName("step"),
        box3d_rollback_h.C_FLOAT.withName("pairs"),
        box3d_rollback_h.C_FLOAT.withName("collide"),
        box3d_rollback_h.C_FLOAT.withName("solve"),
        box3d_rollback_h.C_FLOAT.withName("solverSetup"),
        box3d_rollback_h.C_FLOAT.withName("constraints"),
        box3d_rollback_h.C_FLOAT.withName("prepareConstraints"),
        box3d_rollback_h.C_FLOAT.withName("integrateVelocities"),
        box3d_rollback_h.C_FLOAT.withName("warmStart"),
        box3d_rollback_h.C_FLOAT.withName("solveImpulses"),
        box3d_rollback_h.C_FLOAT.withName("integratePositions"),
        box3d_rollback_h.C_FLOAT.withName("relaxImpulses"),
        box3d_rollback_h.C_FLOAT.withName("applyRestitution"),
        box3d_rollback_h.C_FLOAT.withName("storeImpulses"),
        box3d_rollback_h.C_FLOAT.withName("splitIslands"),
        box3d_rollback_h.C_FLOAT.withName("transforms"),
        box3d_rollback_h.C_FLOAT.withName("sensorHits"),
        box3d_rollback_h.C_FLOAT.withName("jointEvents"),
        box3d_rollback_h.C_FLOAT.withName("hitEvents"),
        box3d_rollback_h.C_FLOAT.withName("refit"),
        box3d_rollback_h.C_FLOAT.withName("bullets"),
        box3d_rollback_h.C_FLOAT.withName("sleepIslands"),
        box3d_rollback_h.C_FLOAT.withName("sensors")
    ).withName("b3Profile");
