...
public class b3DynamicTree {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        box3d_rollback_h.C_POINTER.withName("nodes"),
        box3d_rollback_h.C_INT.withName("root"),
        box3d_rollback_h.C_INT.withName("nodeCount"),
        box3d_rollback_h.C_INT.withName("nodeCapacity"),
        box3d_rollback_h.C_INT.withName("proxyCount"),
        box3d_rollback_h.C_INT.withName("freeList"),
        MemoryLayout.paddingLayout(4),
        box3d_rollback_h.C_POINTER.withName("leafIndices"),
        box3d_rollback_h.C_POINTER.withName("leafBoxes"),
        box3d_rollback_h.C_POINTER.withName("leafCenters"),
        box3d_rollback_h.C_POINTER.withName("binIndices"),
        box3d_rollback_h.C_INT.withName("rebuildCapacity"),
        MemoryLayout.paddingLayout(4)
